        ...
        <div class="container-fluid">
            ...
            <div class="row section1">
                <div class="col-md-6 col-xs-12 lpl-g-header">
                    <h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">LPL Group</h1>
                </div>  
                <div class="col-md-6">
...
<section class="section2 container wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
    <div class="col-md-8">
        <img src="img/lpl1.jpg" class="img-resonsive">
    </div>
...
<section class="section3 container wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
    ...
    <div class="col-md-6">
        <img src="img/lpl_phone.png" class="img-resonsive">
    </div>
</section>
...
<section class="section4 container-fluid wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
    ...
    <img src="img/lpl_newimage-1.png" style="width: 100%;">
    </div>
</section>
...
<section class="section6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s" style="padding: 40px 0px;">
    <div class="container">
        <div class="col-md-6">
            <img src="img/lpl1-1.jpg" style="width: 100%;">
        </div>
        <div class="col-md-6">
            <img src="img/lpl2.jpg" style="width: 100%;">
        </div>
    </div>
</section>
