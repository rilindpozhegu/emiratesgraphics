...
<div class="lg_port" style="margin-bottom:100px;">
    <div class="detailscontainer row">
        <div class="portfolio">
            <div class="col-md-12">
                <h2 class="p_red wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s" style="text-align:center;">PORTFOLIO</h2>
            </div>
            <div class="logo_port">
...
<div class="clearfix"></div>
    <!-- Footer Section -->
    <footer id="contact" class="footer-section mobile-d-n">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h3 class=" wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".5s">Looking for a new website design, brand development or <br>social marketing? We would love to hear from you!</h3>
                </div>
                <div class="col-md-5 button wow fadeInRight" data-wow-duration="2s" data-wow-delay=".5s">
                    <button data-toggle="modal" data-target="#myModalb">GET A FREE QUOTE</button>
                </div>
...
<div class="modal fade" id="myModalb" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <script type="text/javascript">
        $("#em_portfolio").submit(function(e) {
                ...
                $.ajax({
                       type: "POST",
                       url: url,
                       data: $("#em_portfolio").serialize(), // serializes the form's elements.
                       beforeSend: function()
                       {
